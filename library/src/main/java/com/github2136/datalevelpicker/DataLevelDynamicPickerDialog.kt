 ...
 */
class DataLevelDynamicPickerDialog<T : IDataLevel> constructor(onItemSelected: (item: T) -> Unit, onConfirm: (data: MutableList<T>) -> Unit) : DialogFragment(), View.OnClickListener {
